						...
						<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
								...
								<section class="panel">
                                    ...
                                    <div class="form-group">
    										...
    										<select id="noticeresource-notice_id" class="form-control" name="NoticeResource[notice_id]" class="form-control">
    										<?php foreach ($notices as $values){?>
    										<option value="<?php echo $values->notice_id;?>"><?php echo $values->notice_title;?></option>
    										<?php } ?>
    										</select>
											</div>
										</div>
										...
										<div class="form-group">
											<label class="col-sm-2 control-label">Title<span class="required">*</span></label>
											<div class="col-sm-8">
											<input type="text" id="noticeresource-resourece_title" class="form-control" name="NoticeResource[resourece_title]" maxlength="200" aria-required="true" aria-invalid="true">
								...
								<label class="col-sm-2 control-label">File<span class="required">*</span></label>
									...
									<input type="file" name="UploadForm[resource]" id="uploadform-iresource">
										...
										<div class="form-group">
                                            ...
                                            <input type="radio" id="noticeresource-active"  name="NoticeResource[active]" value="1" checked="checked">Active
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" id="noticeresource-active"  name="NoticeResource[active]"  value="0">Inactive
                                            </label>
											</div>
										</div>
