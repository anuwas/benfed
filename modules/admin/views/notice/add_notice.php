						...
						<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="notice-notice_title" class="form-control" name="Notice[notice_title]" maxlength="200" aria-required="true" aria-invalid="true">
  							...
  							<div class="form-group">
									<label class="col-sm-2 control-label">Notice Content<span class="required">*</span></label>
											<div class="col-sm-10">
												<?php echo $form->field($model, 'notice_content')->widget(CKEditor::className());?>
										...
										<div class="form-group">
                                            ...
                                            <input type="radio" id="notice-access"  name="Notice[access]" value="0" checked="checked">Public
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" id="notice-access"  name="Notice[access]"  value="1">Private
                                            </label>
											</div>
										</div>
