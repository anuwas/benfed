								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="cms-page_name" class="form-control" name="Cms[page_name]" maxlength="200" aria-required="true" aria-invalid="true">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="cms-page_title" class="form-control" name="Cms[page_title]" maxlength="200" aria-required="true" aria-invalid="true">
