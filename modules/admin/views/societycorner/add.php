...
?>
				<section role="main" class="content-body">
					<header class="page-header">
						<h2>Add Society Corner Photo</h2>
					...
					<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/notice" class="btn btn-primary">List of Society Corner</a>
										</div>
                                        </div>
								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="societycorner-title" class="form-control" name="SocietyCorner[title]" maxlength="200" aria-required="true" aria-invalid="true">
								...
								<label class="col-sm-2 control-label">Image<span class="required">*</span></label>
									...
									<input type="file" name="UploadForm[resource]" id="uploadform-iresource">
										...
										<div class="form-group">
                                            ...
                                            <input type="radio" id="societycorner-active"  name="SocietyCorner[active]" value="1" checked="checked">Active
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" id="societycorner-active"  name="SocietyCorner[active]"  value="0">Inactive
                                            </label>
											</div>
										</div>
