...
?>
				<section role="main" class="content-body">
					...
					<header class="panel-heading">
								...
								<h2 class="panel-title">Add Tender</h2>
							</header>			
					<div class="row">
						...
						<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="tender-title" class="form-control" name="Tender[title]" maxlength="200" aria-required="true" aria-invalid="true">
  							...
  							<div class="form-group">
									<label class="col-sm-2 control-label">Tender Content<span class="required">*</span></label>
											<div class="col-sm-10">
												<?php echo $form->field($model, 'page_content')->widget(CKEditor::className());?>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input type="radio" id="tender-archive"  name="Tender[archive]" value="0" >Current
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" id="tender-archive"  name="Tender[archive]"  value="1" >Archive
                                            </label>
											</div>
										</div>
