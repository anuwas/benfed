...
?>
				<section role="main" class="content-body">
					...
					<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/siteuser" class="btn btn-primary">List of User</a>
										</div>
                                        </div>
								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="siteuser-siteuser_name" class="form-control" name="SiteUser[siteuser_name]" maxlength="200" aria-required="true" aria-invalid="true">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="siteuser-siteuser_email" class="form-control" name="SiteUser[siteuser_email]" maxlength="200" aria-required="true" aria-invalid="true">
                                        ...
                                        <div class="form-group">
											...
											<div class="col-sm-8">
											<input type="password" id="siteuser-siteuser_password" class="form-control" name="SiteUser[siteuser_password]" maxlength="200" aria-required="true" aria-invalid="true">
