...
?>
				<section role="main" class="content-body">
					...
					<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/notice" class="btn btn-primary">List of Slider</a>
										</div>
                                        </div>
								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="slider_title" class="form-control" name="Slider[title]" maxlength="200" aria-required="true" aria-invalid="true">
								...
								<label class="col-sm-2 control-label">Image<span class="required">*</span></label>
									...
									<input type="file" name="UploadForm[resource]" id="uploadform-iresource">
										...
										<div class="form-group">
                                            ...
                                            <input type="radio" id="slider-active"  name="SliderResource[active]" value="1" checked="checked">Active
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" id="slider-active"  name="SliderResource[active]"  value="0">Inactive
                                            </label>
											</div>
										</div>
