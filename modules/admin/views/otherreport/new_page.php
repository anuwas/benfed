...
?>
				<section role="main" class="content-body">
					...
					<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/otherreport" class="btn btn-primary">List of Pages</a>
										</div>
                                        </div>
								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="otherreport-title" class="form-control" name="OtherReport[title]" maxlength="200" aria-required="true" aria-invalid="true">
									...
									<label class="col-sm-2 control-label">Page Content<span class="required">*</span></label>
										...
										<div class="form-group">
                                            ...
                                            <input type="radio" id="otherreport-active"  name="OtherReport[active]" value="1" checked="checked">Active
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" id="otherreport-active"  name="OtherReport[active]"  value="0">Inactive
                                            </label>
											</div>
										</div>
