...
?>
				<section role="main" class="content-body">
					...
					<div class="row">
									<div class="col-sm-6">
										<div class="mb-md">
											<a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/otherreport/resource" class="btn btn-primary">List of Resource</a>
										</div>
                                        </div>
						...
						<?php $form = ActiveForm::begin(['options' => ['enctype' => 'multipart/form-data','class' => 'form-horizontal']]); ?>
								...
								<section class="panel">
                                    ...
                                    <div class="form-group">
    										...
    										<select id="otherreportresource-report_id" class="form-control" name="OtherReportResource[otherreport_id]" class="form-control">
    										<?php foreach ($otherreport as $values){?>
    										<option value="<?php echo $values->otherreport_id;?>"><?php echo $values->title;?></option>
    										<?php } ?>
    										</select>
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="otherreportresource-resourece_title" class="form-control" name="OtherReportResource[resourece_title]" maxlength="200" aria-required="true" aria-invalid="true">
								...
								<label class="col-sm-2 control-label">Image<span class="required">*</span></label>
									...
									<input type="file" name="UploadForm[resource]" id="uploadform-iresource">
                                       ...
                                       <div class="col-sm-9 col-sm-offset-2">
												...
												<a href="<?php echo  Yii::$app->request->baseUrl;?>/admin/otherreport/resource" class="btn btn-primary">Cancel</a>
											</div>
									</div>
