								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<div class="form-group">
											...
											<div class="col-sm-8">
											<input type="text" id="eventresource-title" class="form-control" name="EventResource[title]" maxlength="200" aria-required="true" aria-invalid="true">
								...
								<label class="col-sm-2 control-label">Image<span class="required">*</span></label>
									...
									<input type="file" name="UploadForm[resource]" id="uploadform-iresource">
										...
										<div class="form-group">
                                            ...
                                            <input type="radio" id="eventresource-active"  name="EventResource[active]" value="1" checked="checked">Active
                                            </label>
                                            <label class="radio-inline">
                                            <input type="radio" id="eventresource-active"  name="EventResource[active]"  value="0">Inactive
                                            </label>
											</div>
										</div>
