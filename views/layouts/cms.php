...
use app\assets\AppCmsAsset;

AppCmsAsset::register($this);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
...
<section id="imgBanner"> 
  ...
  <img class="img-responsive" src="<?php echo Yii::getAlias('@web').'/web/assets/'?>images/who-we-r.jpg" alt="pic"> </section>
