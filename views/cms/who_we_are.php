      ...
      <p> <strong> It functions with the following broad objectives:</strong></p>
            <ul class="objectives">
              <li> <i class="fa fa-angle-double-right" aria-hidden="true"></i>
Marketing of agricultural produce from the farmers through its affiliated cooperative societies.</li>
              <li> <i class="fa fa-angle-double-right" aria-hidden="true"></i>
 Supplying of different agricultural inputs to the farmers through its affiliated cooperative societies.</li>
              <li> <i class="fa fa-angle-double-right" aria-hidden="true"></i>
 Providing technical consultancy to its member cooperatives for construction of Rice Mills, Cold Storages, and agricultural processing units.</li>
            </ul>
